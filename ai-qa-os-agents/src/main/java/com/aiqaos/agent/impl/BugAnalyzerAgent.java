...
@Component
public class BugAnalyzerAgent implements Agent<AgentRequest, AgentResponse> {
    ...
    public AgentResponse execute(AgentRequest request, AgentContext context) {
        ...
        try {
            ...
            promptReq.setTemplateName("BUG_ANALYSIS");
            ...
            llmReq.setSystemPrompt(request.getSystemInstruction() != null ? request.getSystemInstruction() : "You are a Senior QA Bug Analyzer Agent.");
            llmReq.setPurpose("BUG_ANALYSIS");
            llmReq.setAgentType("BUG_ANALYZER");
            ...
            response.setMessage("Failed in BugAnalyzerAgent: " + e.getMessage());
        }
        return response;
    }
