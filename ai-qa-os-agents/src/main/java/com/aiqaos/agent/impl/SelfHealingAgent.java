...
@Component
public class SelfHealingAgent implements Agent<AgentRequest, AgentResponse> {
    ...
    public AgentResponse execute(AgentRequest request, AgentContext context) {
        ...
        try {
            ...
            promptReq.setTemplateName("SELF_HEALING");

            Map<String, Object> params = new HashMap<>();
            // The prompt parameter is structured as JSON context map containing execution, bugAnalysis, learningResult
            ...
            response.setMessage("Failed in SelfHealingAgent: " + e.getMessage());
        }
        return response;
    }
    ...
    public AgentType getType() {
        return AgentType.SELF_HEALING_ENGINEER;
    }
}
