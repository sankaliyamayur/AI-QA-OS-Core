...
@Component
public class ExecutionEngineerAgent implements Agent<AgentRequest, AgentResponse> {
    ...
    public AgentResponse execute(AgentRequest request, AgentContext context) {
        ...
        try {
            ...
            promptReq.setTemplateName("EXECUTION");
            
            Map<String, Object> params = new HashMap<>();
            params.put("scripts", request.getPrompt());
            ...
            response.setMessage("Failed in ExecutionEngineerAgent: " + e.getMessage());
        }
        return response;
    }
    ...
    public AgentType getType() {
        return AgentType.EXECUTION_ENGINEER;
    }
}
