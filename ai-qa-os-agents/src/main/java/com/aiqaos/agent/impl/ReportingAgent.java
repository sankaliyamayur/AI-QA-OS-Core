...
@Component
public class ReportingAgent implements Agent<AgentRequest, AgentResponse> {
    ...
    public AgentResponse execute(AgentRequest request, AgentContext context) {
        ...
        try {
            ...
            promptReq.setTemplateName("REPORT_GENERATION");

            Map<String, Object> params = new HashMap<>();
            params.put("workflowData", request.getPrompt());
            ...
            String defaultInstruction = "You are a Senior QA Reporting Engineer. Generate structured enterprise QA execution reports.";
            ...
            llmReq.setPurpose("REPORT_GENERATION");
            llmReq.setAgentType("REPORTER");
            ...
            response.setMessage("Failed in ReportingAgent: " + e.getMessage());
        }
        return response;
    }
