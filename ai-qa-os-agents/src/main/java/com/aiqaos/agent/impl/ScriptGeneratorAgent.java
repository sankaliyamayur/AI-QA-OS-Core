...
@Component
public class ScriptGeneratorAgent implements Agent<AgentRequest, AgentResponse> {
    ...
    public AgentResponse execute(AgentRequest request, AgentContext context) {
        ...
        try {
            ...
            promptReq.setTemplateName("SCRIPT_GENERATION");
            
            Map<String, Object> params = new HashMap<>();
            params.put("testCases", request.getPrompt());
            ...
            response.setMessage("Failed in ScriptGeneratorAgent: " + e.getMessage());
        }
        return response;
    }
