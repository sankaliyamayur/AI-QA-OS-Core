package com.aiqaos.orchestration.service;
...
public class WorkflowExecutionService {
    ...
    /**
     * AI-2: update the run's status without finalizing it (e.g. PAUSED for human review), so the
     * execution record stays open and resumable rather than being closed by completeExecution.
     */
    public void updateStatus(UUID executionId, String status, String currentStep) {
        workflowExecutionRepository.findByExecutionId(executionId).ifPresent(entity -> {
