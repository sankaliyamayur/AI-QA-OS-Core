...
public class AutonomousQAPipelineTest {
    ...
    public void setUp() {
        ...
        orchestrator = new AutonomousQAPipelineOrchestrator(
                ...
                agentMetricsService,
                bugAnalyticsService,
                // AI-1: no confidence gate in this unit test → orchestrator uses its permissive default.
                new org.springframework.beans.factory.ObjectProvider<com.aiqaos.core.contract.ConfidenceGate>() {
                    @Override public com.aiqaos.core.contract.ConfidenceGate getObject(Object... args) { return null; }
                    @Override public com.aiqaos.core.contract.ConfidenceGate getObject() { return null; }
                    @Override public com.aiqaos.core.contract.ConfidenceGate getIfAvailable() { return null; }
                    @Override public com.aiqaos.core.contract.ConfidenceGate getIfUnique() { return null; }
                },
                // AI-2: real (empty) registry + review service with no persistence in this unit test.
                new com.aiqaos.orchestration.review.PausedWorkflowRegistry(),
                new com.aiqaos.orchestration.review.HumanReviewService(
                    new org.springframework.beans.factory.ObjectProvider<com.aiqaos.orchestration.repository.HumanReviewRepository>() {
                        @Override public com.aiqaos.orchestration.repository.HumanReviewRepository getObject(Object... args) { return null; }
                        @Override public com.aiqaos.orchestration.repository.HumanReviewRepository getObject() { return null; }
                        @Override public com.aiqaos.orchestration.repository.HumanReviewRepository getIfAvailable() { return null; }
                        @Override public com.aiqaos.orchestration.repository.HumanReviewRepository getIfUnique() { return null; }
                    })
        );
    }

    @Test
    @Disabled("MNT-1 quarantine: pre-existing failure (pipeline integration, execution runtime); re-enable when fixed — see FI-MNT1-C")
